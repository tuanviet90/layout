...
class DemoMetrics: UIViewController {
    override func loadView() {
        ...
        let metric = ["Vspace": 20, "Hspace": 20]
        
        self.view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:|-Vspace-[blueRect]", options: nil, metrics: metric, views: views))
